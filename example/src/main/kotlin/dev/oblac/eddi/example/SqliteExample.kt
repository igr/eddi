...
//        println("\n📝 Storing events...")
//
//        val studentId = StudentId("student-001")
//        val courseId = CourseId("course-chem-101")
//
...
//        val enrollmentEvent = Enrolled(studentId, courseId)
...
//        val gradeEvent = Graded(studentId, courseId, "A")
...
//        val lastStudentEvent = eventStoreRepo.findLastTaggedEvent(studentId)
//        if (lastStudentEvent != null) {
//            println("Last event for student ${studentId.id}: ${lastStudentEvent.event::class.simpleName}")
//        }
//
...
//            println("Last grade event for course ${courseId.id}: ${lastGradeEvent.event::class.simpleName}")
//        }
//
...
//    val studentId = StudentId("test-student")
//    val courseId = CourseId("test-course")
//
//    val event = StudentRegistered(studentId, "Test", "Student", "test@example.com")
